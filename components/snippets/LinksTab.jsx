...
export default function LinksTab() {
	return (
		<nav className='border-gray-200 dark:bg-gray-900 p-1 bg-primary'>
			<div className='mx-auto flex max-w-screen-xl flex-wrap items-center justify-center lg:!flex lg:basis-auto'>
				{/* <a
					...
					<ul className='border-gray-100 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 mt-4 flex flex-col rounded-lg border  p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:border-0 md:p-0 rtl:space-x-reverse'>
						<li>
							<Link
								passHref
								href='/dashboard'
								className='text-gray-900 text-white flex flex-row hover:bg-gray-100 dark:hover:bg-gray-700 block rounded px-3 py-2 dark:text-white dark:hover:text-white md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-danger md:dark:hover:bg-transparent md:dark:hover:text-blue-500'
							>
								<MdOutlineHome size={22} /> Home
							</Link>
						</li>
						{/* <li>
							<Link
						...
						{/* <li>
							<a
								href='#'
								className='text-white hover:bg-gray-100 dark:hover:bg-gray-700 block rounded px-2 py-2 dark:text-white dark:hover:text-white md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-blue-500'
							>
								Admin
							</a>
						</li> */}
